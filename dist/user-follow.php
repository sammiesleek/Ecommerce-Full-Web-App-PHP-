                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">User Follow</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ec-breadcrumb-list start -->
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="index.html">Home</a></li>
                                <li class="ec-breadcrumb-item active">Follow</li>
                            </ul>
                        ...
                        <div class="ec-vendor-card-body">
                            <div class="ec-vendor-card-table">
                                <table class="table ec-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="prod-img" src="assets/images/vendor/1.jpg"
                                                    alt="product image"></td>
                                            <td><span>Oreva Fashion</span></td>
                                            <td><span>584</span></td>
                                            <td><span>10</span></td>
                                            <td><span>India</span></td>
                                            <td><span class="tbl-btn"><a class="btn btn-lg btn-primary"
                                                        href="#">Unfollow</a></span></td>
                                        </tr>
                                        <tr>
                                            <td><img class="prod-img" src="assets/images/vendor/2.jpg"
                                                    alt="product image"></td>
                                            <td><span>Astron Mart</span></td>
                                            <td><span>958</span></td>
                                            <td><span>10</span></td>
                                        ...
                                        <tr>
                                            <td><img class="prod-img" src="assets/images/vendor/3.jpg"
                                                    alt="product image"></td>
                                            <td><span>Modern Mart</span></td>
                                            <td><span>56</span></td>
                                            <td><span>10</span></td>
                                        ...
                                        <tr>
                                            <td><img class="prod-img" src="assets/images/vendor/4.jpg"
                                                    alt="product image"></td>
                                            <td><span>Kings Creation</span></td>
                                            <td><span>587</span></td>
                                            <td><span>10</span></td>
                                        ...
                                        <tr>
                                            <td><img class="prod-img" src="assets/images/vendor/5.jpg"
                                                    alt="product image"></td>
                                            <td><span>Amazon Kart</span></td>
                                            <td><span>687</span></td>
                                            <td><span>9</span></td>
                                            <td><span>USA</span></td>
                                            <td><span class="tbl-btn"><a class="btn btn-lg btn-primary"
